...
%	\includegraphics[width=0.45\textwidth]{coneflower_butterfly}
	\includegraphics[width=0.45\textwidth]{columbine_butterfly}
	\end{multicols}
	 
	\vfilll
	
	\hfill \tiny \href{https://www.flickr.com/photos/usfwspacific/4812239589}{\textsc{usfws—p}acific \textsc{r}egion, Flickr, \ccbync{2}}
\end{frame}
%
...
%\end{frame}
%
\begin{frame}[t]{Flowering plants form a \highlight{clade} that share a unique feature, flowers.}
...
\end{frame}
%
\begin{frame}[t]{\ques1 What do you think is the most important feature of a flower for attracting pollinators?}
...
\end{frame}
%
\begin{frame}[t]{\ques{10} Based upon the floral manipulation studies, spurs act to maintain separate \textit{Aquilegia} species by\dots}
...
\begin{frame}[t]{\ques{11} The occurrence of hybrids indicates\dots}
	...
	\hfill \tiny \href{https://www.flickr.com/photos/63093099@N02/32184751505/in/photolist-R34gjH}{plantpollinator}, Flickr, \ccbyncsa{2}
\end{frame}
%
