...
\begin{frame}[t]{The arithmetic \highlight{mean} $\left(\meanY\kern1.67pt\right)$ is a measure of central tendency in the data.}
...
%\hangpara Assume you measured heights for two samples of 4 adults each.
