...
Instead, you will use evidence from the fossil record. Fossils provide evidence of common ancestry because of descent with modification. The descendants have traits that were modified from the ancestral form. The modified traits do not appear suddenly but change slowly over time. These changes can be detected in the fossil record.% shown in the trees below. 
...
\begin{tikzpicture}
	...
	\draw [branch] (5,0) node [below] {Anc. 1} -- (5,1);
	\draw [branch] (3.25,1) -- (6.75,1);
	
	% Tree 1, Left clade
	\draw [branch] (3.25,1) -- (3.25,2);
	\draw [branch] (2.25,2) -- (4.25,2);
	
	\draw [branch] (2.25,2) -- (2.25,3) node [above] {\strut Seastar};
	\draw [branch] (4.25,2) -- (4.25,3) node [above] {\strut Clams};
	
	
	% Tree 1, Right clade
	\draw [branch] (6.75,1) -- (6.75,2);
	\draw [branch] (5.75,2) -- (7.75,2);
	\draw [branch] (5.75,2) -- (5.75,3) node [above] {\strut Fungi};
	\draw [branch] (7.75,2) -- (7.75,3) node [above] {\strut Oak Trees};
	
	% Tree 2
	\draw (11,0) node [below] {Anc. 2} -- (11,1);
	\draw (10,1) -- (12,1);
	\draw (10,1) -- (10,3) node [above] {\strut Dolphin};
	\draw (12,1) -- (12,3) node [above] {\strut Tuna Fish}; 


	\draw [densely dotted, thick] (2,1.5) -- (12.5,1.5);
	\draw [dashed, thick] (2,2.5) -- (12.5,2.5);
