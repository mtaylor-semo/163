...
Use the data above to complete the presence-absence data table. Write a {\liningnum 1} if the species has that character and a {\liningnum 0} if it does not. Notice that the order of the birds in the first column is different from the order given above. Character C{\liningnum 6} has been filled in for you as a guide. You may work in pairs.
...
Once the class has finished compiling the presence/absence data, your instructor will review the results with the entire class. Then, you will learn how to use the data to make a phylogenetic tree.
