...
Download the file called “insect\_diversity.xlsx” from the course data website:\\ \url{http://mtaylor4.semo.edu/~goby/bi163/}.\bigskip
...
\begin{enumerate}[resume]
	...
	\item Add a \axis{y} label, Times New Roman, 12 point, regular style, that reads “Insect Diversity.” \emph{Be sure to remove the bold face if Excel added it.}
...
\AnswerBox{2\baselineskip}{The flood year has a much higher river stage in the spring. The drought year has a much lower river stage overall.}
