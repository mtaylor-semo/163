...
vertebrate animals. Above, you looked at larvae, a development
stage for most  invertebrate animals. Before the embryo or larval stage, all 
animals go through a development stage called the \emph{gastrula.}  
Gastrulas have an opening called the \emph{blastopore.} The blastopore will
become the mouth for most invertebrate organisms, including molluscs and annelids.
...
The blastopore will become the anus for all vertebrates.  Organisms with a blastopore that becomes
the anus are classified as \emph{deuterostomes}. 

\newpage

\question
Based on the information above, is the blastopore becoming a mouth a 
homology or analogy for protostomes? (Protostomes do have an anus.)

\AnswerBox{3\baselineskip}{Should be a homology.}

\question
Based on the information above, is the blastopore becoming an anus a 
