...
%	\item This is Generation 0. Using 0.90 and 0.10 for the starting allele frequencies, calculate the genotype frequencies for Generation 0 and record them in Table~\ref{tab:selection_results} on page~\pageref{tab:selection_results}.
	...
	\item Add up the number of individuals for each genotype \textbf{ but do not record them in Table~\ref{tab:selection_results}.} These are \emph{initial} the Generation~1 individuals.% are the offspring from Generation~0.
	...
	\item Repeat Steps~\ref{selection_sample_start}–\ref{selection_sample_stop} for four more generations (a total of five generations). Record the allele and gentoype frequencies for each generation in Table~\ref{tab:selection_results}.
...
\begin{longtable}[l]{%
	...
	C{0.75in}
	C{0.75in}}
	\caption{Genotype and allele frequencies after five generations of natural selection.
	\label{tab:selection_results}}\tabularnewline
	\toprule
	&
	...
	&
	0.10	&
	0.90 	\tabularnewline[2em]%\rule{0.5in}{0.4pt}	&
	%\rule{0.5in}{0.4pt}	\tabularnewline[2em]
	%
	1	&
	\rule{0.5in}{0.4pt} &
...
& %\rule{0.45in}{0.4pt}	&
& %\rule{0.45in}{0.4pt}	&
\tabularnewline[2em] %\rule{0.45in}{0.4pt}	\tabularnewline[2em]
%Row 2: Generation 1
1		&
\rule{0.45in}{0.4pt}	&
\rule{0.45in}{0.4pt}	&
