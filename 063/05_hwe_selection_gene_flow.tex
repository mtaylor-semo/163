...
\begin{enumerate}
	...
	\item Repeat Steps~\ref{selection_sample_start}–\ref{selection_sample_stop} for four more generations (a total of five generations). Record the allele frequencies for each generation in Table~\ref{tab:selection_results}. Calculate the genotype frequencies for the final generation. 
...
%	
	...
	\item \label{gene_flow_sample_start}Draw 10 individuals at random (how many alleles?) from the Population~1 sack and set them aside. Draw 10 individuals at random from the Population~2 sack and set them aside. You do not have to count their genotypes. \emph{Remove the individuals from each population before you add them to the other ppopulation.}
	...
	\item Repeat steps~\ref{gene_flow_sample_start}–\ref{gene_flow_sample_stop} for 4 more generations (5 total).% Calculate the genotype frequencies of each population for the final generation.
...
\begin{longtable}[l]{%
	...
	C{0.75in}
	C{0.75in}}
	\caption{Genotype and allele frequencies after six generations of sampling.
	\label{tab:selection_results}}\tabularnewline
	\toprule
	&
	...
	&
	0.50	&
	0.50 	\tabularnewline[2em]%\rule{0.5in}{0.4pt}	&
	%\rule{0.5in}{0.4pt}	\tabularnewline[2em]
	%
	1	&
	\rule{0.5in}{0.4pt} &
...
\begin{longtable}[l]{@{}%
	...
	C{0.55in}
	C{0.55in}@{}}
	\caption{Allele and genotype frequencies after five generations of gene flow.}
