...
%	\item This is Generation 0. Using 0.50 each starting allele frequency, 
...
\begin{longtable}[l]{C{0.75in}C{0.75in}C{0.75in}C{0.75in}C{0.75in}C{0.75in}C{0.75in}C{0.75in}C{0.75in}}
	\caption{Observed genotype and allele frequencies for five generations of random sampling.}
	\label{tab:selection_results}\tabularnewline
	\toprule
	&
	\multicolumn{3}{c}{Observed Number of Individuals}	&
	\multicolumn{3}{c}{Observed Genotype Frequencies}  &
	\multicolumn{2}{c}{Obs. Allele Frequencies}\tabularnewline
	%
	\cmidrule(lr){2-4} 
	\cmidrule(l){5-7}
	\cmidrule(l){8-9}	
