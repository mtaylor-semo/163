...
For this figure, you will add error bars to show the standard deviations of each mean. 	\textbf{BE SURE THE FOLLOWING WORKS IN NEW EXCEL}
...
\begin{enumerate}[resume]
	...
	\item Repeat Step~\ref{fir_error} for Lodgepole Pine. Select cells {\liningnum J4:J5}.
...
\begin{enumerate}[resume]
	...
	\item As you did with the previous figures, set the font to Times New Roman, 14 point, regular style for the \textsc{x}- and \textsc{y}-axes. I trust you remember how to do that but, if not, review the instructions above.
...
\begin{enumerate}
	...
	\item Add a primary vertical axis title. Edit the label to read “Gauge Height (feet)”. Add a primary horizontal axis title that reads “Month”. Change both to 14 point, Times New Roman font, regular style.
