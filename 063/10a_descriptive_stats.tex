...
\question
What is the explanatory variable? If you do not remember the difference between explanatory and response variables, see page~\pageref{response_variable}
...
from \popa{} while the other pair samples from \popb{}}. Measure \emph{in millimeters}
 ...
 Table~\ref{corbicula_means} on page~\pageref{corbicula_means}. After you have recorded your 15 measurements,
 return the shells to their bowl. 
 
 \item Switch populations with the other pair of students and repeat
 the sampling process for the other population. \textbf{Do not copy the mean from the other pair of students.}
 	You must calculate your own mean for \emph{each} population.
 
 \emph{Keep the shells of each population separate.} The shells for \popa{}
 have a bright dot of nail polish inside the shell. Do not mix the populations. 
...
\hline
1 & & \tabularnewline[1.2ex]
\hline
2 & & \tabularnewline[1.2ex]
\hline
3 & & \tabularnewline[1.2ex]
\hline
4 & & \tabularnewline[1.2ex]
\hline
5 & & \tabularnewline[1.2ex]
\hline
6 & & \tabularnewline[1.2ex]
\hline
7 & & \tabularnewline[1.2ex]
\hline
8 & & \tabularnewline[1.2ex]
\hline
9 & & \tabularnewline[1.2ex]
\hline
10 & & \tabularnewline[1.2ex]
\hline
11 & & \tabularnewline[1.2ex]
\hline
12 & & \tabularnewline[1.2ex]
\hline
13 & & \tabularnewline[1.2ex]
\hline
14 & & \tabularnewline[1.2ex]
\hline
15 & & \tabularnewline[1.2ex]
\hline
...
\question
Copy the widths $(Y_i)$ you measured for \popa{} from Table~\ref{corbicula_means} into Table~\ref{tab:sdA} on page~\pageref{tab:sdA}. Calculate the standard deviation for \popa{}.
...
\AnswerBox{4\baselineskip}{Could be either.}
