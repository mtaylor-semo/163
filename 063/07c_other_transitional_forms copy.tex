...
\includegraphics[width=\textwidth]{07_fish_amphib_transition}

\begin{longtable}[c]{@{}L{0.48\textwidth}L{0.48\textwidth}@{}}
\toprule
\includegraphics[width=0.45\textwidth]{07_eusthenopteron_skeleton} &
\includegraphics[width=0.45\textwidth]{07_eusthenopteron_limb} \tabularnewline
...
\includegraphics[width=0.45\textwidth]{07_ichthyostega_skeleton} &
\includegraphics[height=2in]{07_ichthyostega_limb}\tabularnewline
