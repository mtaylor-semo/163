...
%the same way during embryonic development.) 
...
\part Describe the structural similarity of the macaque and cat clavicles. What is similar about their 
structure, that is, their shape, location, composition, and other features?

	\AnswerBox{3\baselineskip}{They will probably write simple descriptions.}
...
helpful? 
For the cat, what good is a tiny little bone that does not touch
any other bone?

macaque: \quad \AnswerBox{1\baselineskip}{They may need guidance.}

cat: 	\AnswerBox{1\baselineskip}{}

\part Is the similarity you described above necessary in order to
serve the functions? Explain.

	\AnswerBox{2\baselineskip}{No. The clavicle serves the function of strengthening the shoulder in the macaque. The clavicle does not serve a function in the cat.}
...
\question
Look at the manus (the ``hand'') of the bat and the macaque (muh-KACK, a type of Old World monkey).   The manus is the appendage on the end of the forelimb---a ``front foot'' in the macaque, or most of  the wing of the bat. % Determine if a specific similarity between the bat and the macaque is due to homology or analogy, using the procedure you've gone through before (see Homology/Analogy flow chart to review). 
...
\begin{parts}
	...
	\AnswerBox{2\baselineskip}{Spread out the membrane of the wing for flight.}

	\part What is the function of the manus in the macaque?

	\AnswerBox{2\baselineskip}{Grip branches for flight.}
...
\begin{parts}
	...
	\AnswerBox{2\baselineskip}{Allow's the fingers to bend for gripping.}
		
	\part What is the function of the three phalanges in the alligator and \textit{Necturus}? (Neither animal can grip anything.)

	\AnswerBox{2\baselineskip}{No real function.}
