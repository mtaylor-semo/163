...
\begin{center}
	\includegraphics[width=0.5\textwidth]{02_insert_symbol}
\end{center}
...
\question
What type of graph is most appropriate for these data? Why?

\AnswerBox{3\baselineskip}{Bar/Column chart}

Be sure your graph meets the following requirements:

\begin{enumerate}
	\item Remove horizontal and vertical grid lines,
	...
	\item use black, white, or shades of gray for colors.
