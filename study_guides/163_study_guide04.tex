...
We\marginnote{\textbf{Read:} pages 480--491, including the small box on the lower left of page 486 and complete the scientific skills exercise on page 487,  but skip Natural Selection sections for now.} covered ways other than natural selection that populations evolve, including gene flow, mutation, non-random mating, and genetic drift. We introduced the concept of microevolution.
