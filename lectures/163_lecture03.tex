...
\begin{multicols}{2}
	...
	\onslide<2>\hangpara $T_1$ alleles: $(36 \times 2) + 48 = 120$
	
	\onslide<2,4,9>\hangpara $p = \dfrac{120}{200} = \highlight{\mathbf{0.6}}$

	\onslide<3>\hangpara $T_2$ alleles: $(16 \times 2) + 48 = 80$ 
...
\begin{multicols}{2}
	...
	\onslide<2>\hangpara $R_1$ alleles: $(136 \times 2) + 114 = 386$
	
	\onslide<2,4,9>\hangpara $p = \dfrac{386}{548} = \highlight{\mathbf{0.704}}$

	\onslide<3>\hangpara $R_2$ alleles: $(24 \times 2) + 114 = 162$ 
...
\begin{multicols}{2}
	...
	\onslide<2>\hangpara $L_1$ alleles: $(320 \times 2) + 175 = 815$
	
	\onslide<2,4,11>\hangpara $p = \dfrac{815}{1000} = \highlight{\mathbf{0.815}}$

	\onslide<3>\hangpara $L_2$ alleles: $(5 \times 2) + 175 = 185$ 
