...
%
\begin{frame}[t]{I pretend to have a life outside of work.}

	\begin{multicols}{2}
		\includegraphics[width=0.45\textwidth]{bread_loaves} \\
		\includegraphics[width=0.45\textwidth]{bertha_chicks}
	\end{multicols}
