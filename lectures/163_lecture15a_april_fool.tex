...
\begin{frame}{\reflectbox{Our goal for this lecture is to}}

	\hangpara \reflectbox{show how real populations grow compared to the logistic growth curve,}

	\hangpara \reflectbox{learn about \highlight{density and dispersion} of individuals in a population,}

	\hangpara \reflectbox{learn how \highlight{negative feedback} controls \highlight{density-dependent} population}\\\reflectbox{ growth, and}
	
	\hangpara \reflectbox{learn how \highlight{density-independent} factors control population growth.}
	
\end{frame}
%
{
\usebackgroundtemplate{\reflectbox{\includegraphics[width=\paperwidth]{real_populations_daphnia}} }
\begin{frame}{\reflectbox{Populations initially \highlight{exceed} carrying capacity.}}
\end{frame}
}
%
{
	\usebackgroundtemplate{\reflectbox{\includegraphics[width=\paperwidth]{real_populations_sparrow} }}
	\begin{frame}{\reflectbox{Populations \highlight{fluctuate around} carrying capacity.}}
	\end{frame}
}
%
{
