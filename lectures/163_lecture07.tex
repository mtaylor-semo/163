...
\begin{frame}{Our goal for this lecture and the next is to learn}
	...
	\hangpara how \highlight{allopatric} distributions contribute to speciation,
	
	\hangpara what happens in \highlight{hybrid zones}, and
...
%
\begin{frame}[t]{\highlight{Cryptic species} cannot be distinguished by morphology.}
	
	\begin{multicols}{2}
		{\centering
			\includegraphics[width=0.45\textwidth]{hypsiboas_frogs.pdf}\par
		}
	\columnbreak
		{\centering
			\includegraphics[width=0.5\textwidth]{hypsiboas_map}\par
		}
...
\begin{frame}{The \highlight{cryptic species} are genetically different.}
...
\begin{frame}[b]{\highlight{Allopatric speciation} occurs by geographic isolation.}
...
%
%{
%\usebackgroundtemplate{\includegraphics[width=\paperwidth]{flycatcher_distribution} }
\begin{frame}[b]{\highlight{Reinforcement} reduces chance of forming hybrids.}

	{\centering
		\includegraphics[height=0.87\textheight]{flycatcher_distribution}
