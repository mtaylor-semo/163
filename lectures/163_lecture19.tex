...
\begin{frame}[t]{The global birth rate for 2020 was 18.1 per 1000 people.}
	...
	\tiny \href{https://www.worldometers.info/world-population/}{World Population Clock}\hfill Ali Zifan, Wikimedia Commons, \textsc{cc0}
\end{frame}
%
\begin{frame}[t]{The global death rate for 2020 was 7.6 per 1000 people.}
	...
	\tinyfill United Nations, Wikimedia Commons, \ccbysa{3}
\end{frame}
...
\begin{frame}[b]{The human population growth \emph{rate} is slowing.}
  ...
  \tinyfill Fig.~53.23 \copyright\,Pearson Education, Inc.
\end{frame}
}
%
...
\href{https://climatereanalyzer.org/wx/todays-weather/?var_id=t2&ortho=1&wt=1}{Today's global weather}\bigskip
