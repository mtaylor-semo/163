...
\begin{tikzpicture}
	...
	\draw [thick] (ca.east) -- ++(15:8cm) 
		node [midway, above left, align=right](25up)
			{10 \textsc{ky} later \\\textsc{caattt\textbf{\textcolor{orange6}{g}}tcg}} 
		node [right, above left, align=right](50up)
			{20 \textsc{ky} later\\ \textsc{caat\textbf{\textcolor{orange6}{a}}t\textbf{\textcolor{orange6}{g}}tcg}};
	\draw [thick] (ca.east) -- ++(-15:8cm) 
		node [midway, below left, align=right](25down)
			{\textsc{caa\textbf{\textcolor{orange6}{c}}ttatct}\\10 \textsc{ky} later} 
		node [right, below left, align=right](50down)
			{\textsc{caa\textbf{\textcolor{orange6}{c}}ttatc\textbf{\textcolor{orange6}{t}}}\\20 \textsc{ky} later};
